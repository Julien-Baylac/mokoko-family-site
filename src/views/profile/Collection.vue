<template>
  <div class="collection">
    ...
    >
      <li><a class="collect-switcher">Montures</a></li>
      <li><a class="collect-switcher">Familiers</a></li>
      <li><a class="collect-switcher">Apparences</a></li>
    </ul>

    <ul class="uk-switcher uk-margin">
      <li v-for="item in 3" v-bind:key="item">
        <div
