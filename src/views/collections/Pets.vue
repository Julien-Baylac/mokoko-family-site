<template>
  <div class="mounts">
    <Header wallpaper="pet_wallpaper" title="Les familliers"></Header>
    <div class="uk-container">
      <div class="uk-margin-medium-top">
        <div class="uk-margin-medium-top">
          <ul class="uk-flex-center" uk-tab>
            <li @click="obtentionType = 'all'"><a>Toutes</a></li>
            <li @click="obtentionType = 'quest'"><a>Quetes</a></li>
        ...
        <div style="display: flex; justify-content: space-between">
          <h3 id="table-title" style="margin-bottom: 0">
            Liste des familliers ({{ filteredVehicles.length }})
          </h3>
          <div style="display: flex">
            <div style="display: flex" class="uk-form-small">
              ...
              <select
                ...
                class="uk-select uk-form-small"
              >
                <option :value="null">Trier les familiers obtenues</option>
        ...
        >
          ...
          <li>
            <a class="mount-switcher" @click="vehicleType = 'cat'">Chats</a>
          </li>
          <li>
            <a class="mount-switcher" @click="vehicleType = 'bird'">Oiseaux</a>
          </li>
          <li>
            <a class="mount-switcher" @click="vehicleType = 'mokoko'"
              >Mokokos</a
            >
          </li>
          <li>
            <a class="mount-switcher" @click="vehicleType = 'toto'">Totos</a>
          </li>
          <li>
            <a class="mount-switcher" @click="vehicleType = 'lion'">Lions</a>
          </li>
        </ul>
